...
const BUILD='08.06 · зоны строго по месяцу (Финансы)';
...
try{ _repairZoneRosters(); }catch(e){}   // one-time: клиент с отметками за месяц M попадает в ростер зоны M (зоны стали строгими)
render();
