...
function renderDayTasks(iso){
  ...
  const carried = dayTasks.filter(t=>t.startIso<iso).sort((a,b)=>a.startIso.localeCompare(b.startIso));
  const own     = dayTasks.filter(t=>t.startIso===iso);
